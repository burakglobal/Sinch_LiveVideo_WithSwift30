...
//  SincClinet.swift
//
//  Created by BURAK KEBAPCI on 3/20/17. 
...
var _sincallclient: SINCallClient?
var push: SINManagedPush?
var _transfercall: SINCall?
let notificationName = Notification.Name("NotificationIdentifier")
var getc = "0"
var callprice = 0.0017
var durationTimerx: Timer!
...
extension UIView {
    ...
    func toBottomAnimation(duration: TimeInterval = 0.5, completionDelegate: AnyObject? = nil) {
        // Create a CATransition object
        let leftToRightTransition = CATransition()
        ...
        leftToRightTransition.type = kCATransitionPush
        leftToRightTransition.subtype = kCATransitionFade
        leftToRightTransition.duration = duration
        leftToRightTransition.timingFunction = CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseInEaseOut)
        leftToRightTransition.fillMode = kCAFillModeRemoved
